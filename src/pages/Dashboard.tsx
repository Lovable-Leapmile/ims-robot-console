...
const Dashboard = () => {
  ...
  const fetchStatus = async (topic: string, setStatus: (data: any) => void) => {
    ...
    try {
      const response = await fetch(
        `https://event.internal.leapmile/pubsub/subscribe?topic=${topic}&num_records=1`,
        {
          headers: {
            'accept': 'application/json',
  ...
  const handleAMRAction = async (action: "pick" | "drop") => {
    ...
    try {
      const response = await fetch(
        'https://event.internal.leapmile/pubsub/publish?topic=AMR_1',
        {
          method: 'POST',
          headers: {
            'accept': 'application/json',
  ...
  const handleBayDoorAction = async (action: "open_door" | "close_door") => {
    ...
    try {
      const response = await fetch(
        'https://event.internal.leapmile/pubsub/publish?topic=Bay',
        {
          method: 'POST',
          headers: {
            'accept': 'application/json',
  ...
  const handleLockerAction = async (action: "open" | "close") => {
    ...
    try {
      const response = await fetch(
        'https://event.internal.leapmile/pubsub/publish?topic=LOCKER',
        {
          method: 'POST',
          headers: {
            'accept': 'application/json',
  ...
  const handleConveyorAction = async (action: "eject" | "inject") => {
    ...
    try {
      const response = await fetch(
        'https://event.internal.leapmile/pubsub/publish?topic=Conveyor',
        {
          method: 'POST',
          headers: {
            'accept': 'application/json',
  ...
  const handleScissorLiftAction = async (action: "start" | "stop") => {
    ...
    try {
      const response = await fetch(
        'https://event.internal.leapmile/pubsub/publish?topic=SCISSOR_LIFT',
        {
          method: 'POST',
          headers: {
            'accept': 'application/json',
